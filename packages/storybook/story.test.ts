...
import {defineStorybookStories, defineStorybookStoryModule, storyRoute, type StorybookStoryModule} from "./story.ts"
...
describe("typed storybook story registry", () => {
  ...
  test("rejects ambiguous hierarchy and invalid story modules", async () => {
    ...
    })).toThrow("Duplicate storybook story component")
