...
export function createPrimitiveStory(options: Readonly<{
  ...
  return defineStorybookStoryModule<PrimitiveStoryArgs>({
    defaultArgs: initial,
...
function primitiveControls(
  component: PrimitiveStoryComponent,
): readonly StorybookStoryControl<keyof PrimitiveStoryArgs & string>[] {
  const common: StorybookStoryControl<keyof PrimitiveStoryArgs & string>[] = [
    {
      key: "tone",
      label: "Акцент",
      group: "Внешний вид",
